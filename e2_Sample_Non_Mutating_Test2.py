...
e30=Employee(30,'l30',"L30-corp",4278,28)
...
def test_get_department_name():
    ...
    for item in [e3,e23,e88,e41,e42,e43,e51,e61,e7,e30]:
        assert item.get_department_name()==''
...
def test_get_position_in_hierachy():
    #more
    assert L58.get_position_in_hierarchy() == 'L58-C, C, B'
    assert e38.get_position_in_hierarchy() == 'E38, B'
    assert e48.get_position_in_hierarchy() == 'E48, B'
    assert L81.get_position_in_hierarchy() == 'L81-B, B'
    assert e23.get_position_in_hierarchy() == 'E23'
    assert e3.get_position_in_hierarchy() == 'E3'
    assert L80.get_position_in_hierarchy() == 'L80-J, J'
    assert e4.get_position_in_hierarchy() == 'E4, J'
    assert e5.get_position_in_hierarchy() == 'E5, J'
    assert e6.get_position_in_hierarchy() == 'E6, J'
    assert L82.get_position_in_hierarchy() == 'L82-A, A'
    assert L83.get_position_in_hierarchy() == 'L83-D, D, A'
    assert L39.get_position_in_hierarchy() == 'L39-E, E, A'
    assert L84.get_position_in_hierarchy() == 'L84-F, F, D, A'
    assert L85.get_position_in_hierarchy() == 'L85-G, G, D, A'
    assert L86.get_position_in_hierarchy() == 'L86-H, H, D, A'
    assert e7.get_position_in_hierarchy() == 'E7'
    assert L77.get_position_in_hierarchy() == 'L77-I, I'
    assert L78.get_position_in_hierarchy() == 'L78-IB, IB'
    assert e88.get_position_in_hierarchy() == 'E88'
    assert e41.get_position_in_hierarchy() == 'E41'
    assert e42.get_position_in_hierarchy() == 'E42'
    assert e43.get_position_in_hierarchy() == 'E43'
    assert e51.get_position_in_hierarchy() == 'E51'
    assert e61.get_position_in_hierarchy() == 'E61'
    assert e30.get_position_in_hierarchy() == "L30-corp"
...
if __name__ == '__main__':
    ...
    pytest.main(['e2_Sample_Non_Mutating_Test2.py'])