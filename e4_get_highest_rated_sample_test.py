...
#######
# More This test file will change some rating info of nodes to create duplicates
#changed places have been commented #change
#######
def generate():
    ...
    L84 = Leader(84, 'l84', 'L82-F', 4367, 98, 'F') #change
    ...
    e41 = Employee(41, "e41", 'E41', 4234, 51) #change
    ...
    e4 = Employee(4, 'e4', 'E4', 4444, 35) #change
    e5 = Employee(5, 'e5', 'E5', 4454, 39) #change
    e6 = Employee(6, 'e6', 'E6', 4464, 98) #change
    ...
    L78 = Leader(78, 'l78', 'L78-IB', 4557, 73, 'IB') #change
...
def test():
    dictt=generate()
    for item in ['e4', 'e5', 'e6', 'e61', 'e23', 'e38', 'l39', 'e42', 'e43', 'e48', 'e51', 'l58', 'l77',
                 'l78', 'l84', 'l85', 'l86']:
        assert dictt[item].get_highest_rated_subordinate() is None
    assert dictt['l30'].get_highest_rated_subordinate() is dictt['l80']
    assert dictt['e3'].get_highest_rated_subordinate() is dictt['l81']
    assert dictt['l81'].get_highest_rated_subordinate() is dictt['l58']
    assert dictt['l82'].get_highest_rated_subordinate() is dictt['l39']
    assert dictt['l83'].get_highest_rated_subordinate() is dictt['l84']
    assert dictt['e88'].get_highest_rated_subordinate() is dictt['e41']
    assert dictt['e41'].get_highest_rated_subordinate() is dictt['e51']
    assert dictt['l80'].get_highest_rated_subordinate() is dictt['e6']
    assert dictt['e7'].get_highest_rated_subordinate() is dictt['l77']
    assert dictt['single_l'].get_highest_rated_subordinate() is None
    assert dictt['single_e'].get_highest_rated_subordinate() is None

if __name__ == '__main__':
    import pytest
    pytest.main(['e4_get_highest_rated_sample_test.py'])
